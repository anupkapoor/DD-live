<?php include "../../config.php"; ?>
	<?php include "../../header-lp-chicago.php"; ?>
		<!-- Home -->
					...
					<div class="container">
						<div class="row ">
							<div class="col-12 col-sm-12 col-md-12 col-lg-7">
								...
								<h1><span>Chicago's</span> Top Web & <span>Mobile App</span> Development <span>Company</span></h1>
								<p>Our local development team looks forward to meeting you in person at our office in Chicago to turn your app idea into a multi-million dollar business.</p>
							</div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
     <p class="text-center"><span style="color: #1e6ebe; font-size:30px">Our Valued Chicago Based Clients</span></p>
       ...
       <img src="<?php echo BASE_URL ?>/images/client-logos-1-lp.png" alt="Client Logos" class="img-fluid" />
			...
			<section class="section-3-lp gray-section-lp py-5">
				<div class="container-fluid">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="text-center">What Our <span style="color: #1e6ebe;">Clients Based In Chicago</span> Have To Say About Working With <span style="color: #1e6ebe;">Dedicated Developers Local Development Team</span></h2> </div>
						</div>
			...
			<section class="section-4-lp  py-5">
				<div class="container-fluid">
					<div class="container px-4">
						<div class="row pb-4">
							<div class="col">
								<h2 class="text-center">We Love Helping Our Chicago Neighbors But... <br /><span style="color: #1e6ebe;">We’ve Also Helped Companies In More Than 25 Countries Launch The Web & Mobile Apps They Needed To Succeed</span></h2>
							</div>
						</div>
												...
												<div class="p-3 shadow rounded">
													<div class="row">
														...
														<div class="col pt-3 line-height-1">
															...
															<!-- <p class="m-0 p-0 text-style-1-lp">Chicago, GA</p>-->
			...
			<section class="section-5-lp  py-5">
				<div class="container-fluid pb-1">
					<div class="container">
						<h2 class="pb-2">Your Chicago-Based Development Team <br />with a Worldwide Reach</h2>
					...
					<li><a href="<?php echo PORTFOLIO_URL ?>/doctors-beyond/" target="_blank">
							...
							<div class="portfolio-hover">
								<div class="portfolio-hover-content">
									...
									<p class="map-location">Chicago, GA</p>
								</div>
							</div>
						...
						<a href="<?php echo PORTFOLIO_URL ?>/gorilla-glass/" target="_blank">
							...
							<div class="portfolio-hover">
								<div class="portfolio-hover-content">
									...
									<img src="images/map-location.png" alt=""  />
									<p class="map-location">Chicago, NY</p>
								</div>
							</div>
				...
				<div class="container pt-1">
					<div class="row py-5">
						...
						<div class="col-md-12 col-lg-6">
							<p>With Dedicated Developers you get the best of both worlds – Chicago-based UI/UX architects as well as experienced app development team - all supervised by the leadership team which understands both the coding world as well as launching successful online businesses. We’ll walk you through our unique 'Idea to App Blueprint' process and then our experienced Chicago team will keep you well informed as we turn your app idea into a customer getting profit machine. <br></p>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="col-12 pb-3"> <p><strong style="font-size: 18px; display:block; text-align:center;">With Dedicated Developers you enjoy:</strong></p></div>
						...
						<div class="col-12 col-sm-6 col-md-3 section-9-box">
							<div class="col-md-12 section-9-box-inner">
								<div class="process-info-hover">
									<ul>
									   <li>Chicago Based Delivery Team</li>
			...
			<section class="section-10-lp pb-0 pt-4 mb-0 relative-negative-170">
				<div class="container-fluid">
					<div class="container">
						<div class="row py-3">
							<div class="col-md-12">
									<h2 class="text-center">Mobile App Development Services <br />In Chicago</h2>
							</div>
						</div>
						<div class="row pb-3">
...
<!--								<p class="pt-3">Our expert developers are up-to-date on all the very latest app languages and innovations. We are able to fully utilize all of the following:</p> -->
                                    <p class="pt-3">One of Chicago’s Most Awarded Development Firm is up-to-date on all the very latest app languages and innovations. We are able to fully utilize all of the following:</p>
							</div>
						</div>
					</div>
					<div class="container">
							...
							<div class="col-12 col-sm-12 col-md-6 col-lg-6">
								...
								<div class="row address-block-lp  p-4">
									...
									<div class="col-sm-8 col-md-9 px-4 pt-4">
										...
										Phone: (312) 761-4448<br />
										Email: Chicago@DedicatedDevelopers.com</p>
									</div>
								</div>
							</div>
							<div class="col-12 col-sm-12 col-md-6 col-lg-6 ">
