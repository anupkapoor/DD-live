		...
		<div class="landing-page-v">
					...
					<div class="container">
						<div class="row ">
							<div class="col col-md-7">
								<p><strong>Stand Out from the Competition & Grow at a Faster Pace ...</strong></p>
								<h1>Top <span>Web</span>& <br />Mobile <span>App</span><br />Development<br /><span>Company in Atlanta!</span></h1>
			...
			<section class="section-3-lp gray-section-lp py-5">
				<div class="container-fluid">
					<div class="container">
						<div class="row">
							<div class="col">
								<h2 class="text-start">What Clients Have to Say About Working With Atlanta-Based Dedicated Developers:</h2> </div>
						</div>
			...
			<section class="section-5-lp  py-5">
				<div class="container-fluid pb-1">
					<div class="container">
						<h2 class="pb-2">Atlanta-Based With a Worldwide Reach</h2>
                        <p class="pb-5 text-center">We Have the Talent & Resources to Turn Your App into Reality!</p>
						<div class="row">
				...
				<div class="container">
					<div class="row pb-0">
						...
						<div class="col-md-6 section-6-lp-right">
							<div class="row">
								<div class="col-md-4 section-6-white"><p><strong>475+</strong></p><p>Talented Developers</p></div>
								<div class="col-md-4 section-6-blk"><p><strong>650+</strong></p><p>Apps Completed</p></div>
								<div class="col-md-4 section-6-white"><p><strong>2000+</strong></p><p>Clients Served</p></div>
							</div>
							<div class="row">
								<div class="col-md-4 section-6-blk"><p><strong>55+</strong></p><p>Awards Received</p></div>
								<div class="col-md-4 section-6-white"><p><strong>15+</strong></p><p>Years in Business</p></div>
			...
			<div class="container-fluid">
				<div class="container">
					<div class="row py-0">
						<div class="col-md-5">
							<ul class="mb-0">
								<li>Determine if your app idea is feasible</li>
								<li>Get an idea of how the app would function</li>
							...
							<div class="moonray-form-p2c21081f178 ussr">
									<div class="form-landing-page2 moonray-form  moonray-form-label-pos-stacked">
										<form class="moonray-form-clearfix" action="https://forms.ontraport.com/v2.4/form_processor.php?" method="post" accept-charset="UTF-8">
											<div class="moonray-form-element-wrapper moonray-form-element-wrapper-alignment-left moonray-form-element-html">
												<div id="mr-field-element-917789526240" class=" moonray-form-element-html">
													<h3>Get a Free App Blueprint & Consultation!</h3></div>
											</div>
											<div class="moonray-form-element-wrapper moonray-form-element-wrapper-alignment-left moonray-form-input-type-text">
												<label for="mr-field-element-954250408779" class="moonray-form-label"></label>
												<input name="firstname" type="text" class="moonray-form-input" id="mr-field-element-954250408779" required value="" placeholder="First Name*" />
