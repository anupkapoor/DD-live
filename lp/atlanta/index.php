<?php include "../../config.php"; ?>
	<?php include "../../header-lp-atlanta.php"; ?>
		...
		.section-7-lp .portfolio-listing .portfolio-hover-content p:nth-child(2){font-size:16px;}
		    a{
		        text-decoration:none;
		    }
		    .landing-page-v {padding-top: 60px;}
		    .mega-menu-block {top: 95px;}
		    .desktop-menu li.hire-developer-menu:hover > a::after , .desktop-menu li.solution-developer-menu:hover > a::after {bottom: -13px;}
		    #neil-nav ul {
    padding: 0;
}
