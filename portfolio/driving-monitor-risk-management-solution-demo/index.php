...
<?php include('../../portfolio-header.php'); ?>
    ...
    <div id="portfolio" class="portfolio-inner-img gymsource">
        <section class="banner">
			<img class="responsive-img" src="images/driving-monitor-banner.png" alt="Driving Monitor Banner">
		</section>
        <!-- The Story -->
...
<?php //include(BASE_URL . '/blog-section.php'); ?>
		<section class="pagination">
			<div class="container-block">
				<div class="threecolumn">
					<a href="<?php echo PORTFOLIO_URL ?>/<?php echo $previous_portfolio; ?>"><img src="images/left-arw.png" alt="Next"/><h4>Super Cool Learning Tools</h4></a>
				</div>
				...
				<div class="threecolumn">
					<a href="<?php echo PORTFOLIO_URL ?>/<?php echo $next_portfolio; ?>"><img src="images/right-arw.png" alt="Previous"/><h4>MayDay Alarm</h4></a></div>
				</div>
			</div>
		</section>
	</div>
