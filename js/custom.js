$(document).ready(function() {
 if (/iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
        ...
        $(".quote-request").click(function() {
            window.location.href = "https://dedicateddevelopers.com/request-a-quote.php";
        });
    } else {}
          ...
          if (sub_menu.hasClass("shown")) {
            ...
            $(".top_level").each(function() {
              ...
              if (next_li != clicked) {
				...
				$(next_li).find(".child-mob-menu").hide().parent().removeClass('active-item');
              }
            });
          }
        });
    ...
    setInterval(function() {
        $('#slideshow2 > div:first').fadeOut(500).next().fadeIn(500).end().appendTo('#slideshow2');
    }, 2000);
        ...
        var t = setInterval(function() {
            if ('complete' === document.readyState) {
                ...
                $('.developement-row,.tech-wrap-v,.industries-row-v').each(function() {
                    var highestBox = 0;
                    $('.two-columns,.boxes_con,.industries-block-v,.industry-content-wrap,.industry-content-img', this).each(function() {
                        if ($(this).height() > highestBox) {
                            highestBox = $(this).height();
                        }
                    });
                    $('.two-columns,.boxes_con,.industries-block-v,.industry-content-wrap,.industry-content-img', this).height(highestBox);
                });
            }
        }, 100);
    })(window, document);
...
$("#close-video").click(function(){
 ...
 jQuery('#showVideo1').click(function () {
        jQuery('#opened-video').fadeIn().html('<div class="center-make"><div class="center-inner-video"><div class="responsive-iframe"><iframe id="video-iframe" src="https://player.vimeo.com/video/468762813?autoplay=1" width="1080" height="608" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div></div></div>');
		
		jQuery('#close-video').show();
    });
     jQuery('#showVideo2').click(function () {
        jQuery('#opened-video').fadeIn().html('<div class="center-make"><div class="center-inner-video"><div class="responsive-iframe"><iframe id="video-iframe" src="https://player.vimeo.com/video/468762892?autoplay=1" width="1080" height="608" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div></div></div>');
		jQuery('#close-video').show();
    });
	
	  jQuery('#showVideo3').click(function () {
        jQuery('#opened-video').fadeIn().html('<div class="center-make"><div class="center-inner-video"><div class="responsive-iframe"><iframe id="video-iframe" src="https://player.vimeo.com/video/468762736?autoplay=1" width="1080" height="608" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div></div></div>');
		jQuery('#close-video').show();
    });
	  jQuery('#showVideo4').click(function () {
        jQuery('#opened-video').fadeIn().html('<div class="center-make"><div class="center-inner-video"><div class="responsive-iframe"><iframe id="video-iframe" src="https://player.vimeo.com/video/471069781?autoplay=1" width="1080" height="608" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div></div></div>');
		jQuery('#close-video').show();
    });
