<?php include "config.php"; ?>
	<?php include "header-lp-atlanta-no-index.php"; ?>
		...
		<div class="landing-page-v">
			...
			<section class="section-12-lp gray-gradient-section-lp py-5">
			<div class="container-fluid">
				<div class="container">
					<div class="row pb-0">
						<div class="col-12 col-sm-12 col-md-12 text-center ">
							    <p class="text-center" style="margin-bottom:8px">We are headquartered in <strong>Atlanta</strong> and have development teams in <strong>San Francisco</strong>, <strong>Los Angeles</strong>, <strong>New York City</strong>, <strong>Chicago</strong>, and <strong>Boston</strong>.</p><p class="text-center" style="margin-bottom:0">Our award-winning local US-based development team looks forward to meeting you in person at one of our offices OR on a Zoom call to help you turn your app idea into a multi-million dollar business. </p>
