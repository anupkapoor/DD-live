...
<!-- Global site tag (gtag.js) - Google Ads: 965442346 -->
	...
	<!-- Event snippet for Contact Us Form Completion conversion page In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. --> <script> function gtag_report_conversion(url) { var callback = function () { if (typeof(url) != 'undefined') { window.location = url; } }; gtag('event', 'conversion', { 'send_to': 'AW-965442346/HafzCP6JzWIQqvatzAM', 'event_callback': callback }); return false; } </script> 
