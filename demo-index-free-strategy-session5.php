			...
			<section class="section-1-lp  py-5 pb-3 my-4">
				<div class="container-fluid">
					...
					<a class="input-two-col" target="_blank" rel="nofollow" href="https://clutch.co/profile/dedicated-developers"><img src="https://dedicateddevelopers.com/images/we-delever-cluch.png" alt="Client Say We Deliver on Clutch" class="responsive-img" width="auto" height="auto"></a></div>  
						...
						<div class="row  text-center"><div class="col-12"><p class="pt-3" style="max-width:none;">We are headquartered in <strong>Atlanta</strong> and have development teams in <strong>San Francisco</strong>, <strong>Los Angeles</strong>, <strong>New York City</strong>, <strong>Chicago</strong>, and <strong>Boston</strong>. Our award-winning local US-based development team looks forward to meeting you in person at one of our offices OR on a Zoom call to help you turn your app idea into a multi-million dollar business. </p></div></div>
					</div>
				</div>
			</section>
